...
def get_employee_todo_progress(employee_id):
    ...
    try:
        ...
        """THis script fetches the todos list for an employee
        note that we use todos"""
